    ...
    >
      {loading && (
        <div className="p-6 space-y-4 animate-pulse">
          <div className="h-8 w-32 bg-zinc-100 dark:bg-[#1c1c1e] rounded" />
          <div className="space-y-3">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="flex justify-between">
                <div className="h-4 w-16 bg-zinc-100 dark:bg-[#1c1c1e] rounded" />
            ...
            <button
              ...
              className={`px-3 h-8 text-sm font-medium rounded-full transition-colors cursor-pointer ${
                activeTab === 'review'
                  ...
                  : 'bg-white dark:bg-[#1c1c1e] border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700'
              }`}
            >
              Review
            </button>
